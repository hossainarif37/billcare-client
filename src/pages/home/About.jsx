    ...
    return (
        <section className='flex flex-col-reverse lg:flex-row items-center'>
            ...
            <div className='text-[#04083A] px-3 lg:pl-4 py-4 lg:py-0'>
                ...
                <h3 className='text-2xl py-3 lg:py-5 '>With BillCare, you can pay for airtime, internet data, electricity <br className='hidden lg:block xl:hidden' />
                    bills, make flight ticket reservations, and access free medical <br className='hidden lg:block xl:hidden' />
                    consultations.
                </h3>
