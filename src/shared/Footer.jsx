        ...
        <>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <p><span className="font-bold">Bill Care</span><br />For all your Bill Payments and Reservations</p>
                </div>
                <div>
            ...
            <div className="footer footer-center p-4 bg-base-200 text-base-content">
                <div>
                    <p>Copyright © {date} - All right reserved by <span className="font-semibold">Bill Care </span>Industries Ltd</p>
                </div>
            </div>
        </>
    );
